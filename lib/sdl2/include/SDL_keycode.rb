module SDL2
  ...
  # Enum: SDL_Keymod
  const_set :KMOD_NONE,     0x0000
  const_set :KMOD_LSHIFT,   0x0001
  const_set :KMOD_RSHIFT,   0x0002
  const_set :KMOD_LCTRL,    0x0040
  const_set :KMOD_RCTRL,    0x0080
  const_set :KMOD_LALT,     0x0100
  const_set :KMOD_RALT,     0x0200
  const_set :KMOD_LGUI,     0x0400
  const_set :KMOD_RGUI,     0x0800
  const_set :KMOD_NUM,      0x1000
  const_set :KMOD_CAPS,     0x2000
  const_set :KMOD_MODE,     0x4000
  const_set :KMOD_RESERVED, 0x8000
  typealias 'SDL_Keymod', 'int'

  const_set :KMOD_CTRL,  (KMOD_LCTRL  | KMOD_RCTRL)
  const_set :KMOD_SHIFT, (KMOD_LSHIFT | KMOD_RSHIFT)
  const_set :KMOD_ALT,   (KMOD_LALT   | KMOD_RALT)
  const_set :KMOD_GUI,   (KMOD_LGUI   | KMOD_RGUI)
end
