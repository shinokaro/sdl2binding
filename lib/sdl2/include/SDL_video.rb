module SDL2
  ...
  const_set :SDL_WINDOWPOS_ISUNDEFINED,       -> (x) { (x & 0xFFFF0000) == SDL_WINDOWPOS_UNDEFINED_MASK }
  ...
  const_set :SDL_WINDOWPOS_ISCENTERED,        -> (x) { (x & 0xFFFF0000) == SDL_WINDOWPOS_CENTERED_MASK }
